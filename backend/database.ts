  ...
  return new Promise((resolve, reject) => {
    db = new verboseSqlite.Database(DB_PATH, (err) => {
      ...
      db.serialize(() => {
        ...
        db.run("ALTER TABLE users ADD COLUMN todos TEXT DEFAULT '[]'", () => {});
        db.run("ALTER TABLE users ADD COLUMN workCalendarUrl TEXT", () => {});
        db.run("ALTER TABLE users ADD COLUMN personalCalendarUrl TEXT", () => {});
